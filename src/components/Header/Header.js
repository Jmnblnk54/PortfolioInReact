                    ...
                    <Col sm="5">
                        <Animated animationIn="fadeInDown" animationInDelay="500" isVisible={true}>
                            <Row>
                                ...
                                <Col>
                                <h1 className="text-secondary m-0">Joshua Blank</h1>
                                </Col>   
                            </Row>
                        </Animated>
                    ...
                    <Col md="6" sm="7">
                        <Nav className="float-sm-right justify-content-center">
                            <Animated animationIn="fadeInDown" animationInDelay="1200" isVisible={true}>
                                {/* LinkedIn */}
                                <NavLink className="text-secondary m-1" href="https://www.linkedin.com/in/joshua-blank/">
                            ...
                            <Animated animationIn="fadeInDown" animationInDelay="1400" isVisible={true}>
                                {/* GitHub */}
                                <NavLink className="text-secondary m-1" href="https://github.com/Jmnblnk54">
                                    <Row className="justify-content-center">
                                        <span>
                            ...
                            <Animated animationIn="fadeInDown" animationInDelay="1600" isVisible={true}>
                                {/* Resume */}
                                <NavLink className="text-secondary m-1" href="assets/docs/JoshBlankResume.pdf">
                                    <Row className="justify-content-center">
                                        <span>
                            ...
                            <Animated animationIn="fadeInDown" animationInDelay="1800" isVisible={true}>
                                {/* MailTo link */}
                                <NavLink className="text-secondary m-1" href="mailto:jmnblnk@yahoo.com">
                                    <Row className="justify-content-center">
                                        <span>
